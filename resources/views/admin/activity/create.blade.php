...
<div class="layui-container"layui-bg-gray>
    ...
    <form class="layui-form" action="{{route('activity.store')}}" method="post">
        {{ csrf_field() }}
        <div class="layui-form-item">
            <label class="layui-form-label">标题</label>
            <div class="layui-input-block">
                <input type="text" lay-verify=""  value="" name="title"
            ...
            <div class="layui-input-block">
                <div class="layui-upload">
                    ...
                    <div class="layui-upload-list">
                        <img class="layui-upload-img" id="demo1" name="">
                        <p id="demoText"></p>
                    </div>
                </div>
                <input type="hidden" lay-verify=""  value="" name="title_url"
                 placeholder="" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="explanation" placeholder="多个点请用@逗号隔开,例如：a@b@c" class="layui-textarea"></textarea>
               </div>
